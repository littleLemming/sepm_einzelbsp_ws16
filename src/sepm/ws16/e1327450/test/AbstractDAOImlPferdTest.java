...
public abstract class AbstractDAOImlPferdTest {
    ...
    public void loadWithValid() throws PersistenceException {
        ...
        Pferd pferd = new Pferd("0000","Philidor","Trakhner",22,"0000_philidor_1.jpg",53,60);
    ...
    public void loadAllTest() throws PersistenceException {
        ...
        pferdList.add(new Pferd("0000","Philidor","Trakhner",22,"0000_philidor_1.jpg",53,60));
        pferdList.add(new Pferd("0001","Rusty","Shetland Pony",16,"0001_rusty_0.jpg",40,46));
        pferdList.add(new Pferd("0002","Kori","Huzule",13,"0002_kori_1.jpg",40,51));
        pferdList.add(new Pferd("0003","Jaris","Fjordpony",9,"0003_jaris_2.jpg",56,59));
        pferdList.add(new Pferd("0004","Pia","Haflinger",17,"0004_pia_0.jpg",43,55));
        pferdList.add(new Pferd("0005","Benji","Haflinger-Noriker",15,"0005_benji_1.jpg",40,44));
        pferdList.add(new Pferd("0006","Szilja","Araber",12,"0000_szilja_0.jpg",48,57));
    ...
    public void loadConditionTest() throws PersistenceException {
        ...
        List<Pferd> pferdList = new ArrayList<>();
        Pferd pferd0 = new Pferd("0000","Philidor","Trakhner",22,"0000_philidor_1.jpg",53,60);
        Pferd pferd1 = new Pferd("0001","Rusty","Shetland Pony",16,"0001_rusty_0.jpg",40,46);
        Pferd pferd2 = new Pferd("0002","Kori","Huzule",13,"0002_kori_1.jpg",40,51);
        Pferd pferd3 = new Pferd("0003","Jaris","Fjordpony",9,"0003_jaris_2.jpg",56,59);
        Pferd pferd4 = new Pferd("0004","Pia","Haflinger",17,"0004_pia_0.jpg",43,55);
        Pferd pferd5 = new Pferd("0005","Benji","Haflinger-Noriker",15,"0005_benji_1.jpg",40,44);
        Pferd pferd6 = new Pferd("0006","Szilja","Araber",12,"0000_szilja_0.jpg",48,57);
        List<Pferd> pferdListLoaded = daoPferd.loadCondition(null, -1, -1, -1, -1, -1, -1);
        ...
        pferdListLoaded = daoPferd.loadCondition(null, 4, 10, -1, -1, -1, -1);
        ...
        pferdListLoaded = daoPferd.loadCondition(null, -1, -1, 47, 53, -1, -1);
        pferdList = new ArrayList<>();
        pferdList.add(pferd0);
        ...
        pferdListLoaded = daoPferd.loadCondition(null, -1, -1, -1, -1, 55, 60);
        pferdList = new ArrayList<>();
        pferdList.add(pferd0);
        pferdList.add(pferd3);
    ...
    public void createWithValid() throws PersistenceException {
        logger.info("createWithValid()");
        Pferd pferd = new Pferd("0007","Frosty","Warmblut-Mix",7,"0007_frosty_0.jpg",43,55);
    ...
    public void createWithExistingId() throws PersistenceException {
        ...
        Pferd pferd = new Pferd("0005","Frosty","Warmblut-Mix",7,"0007_frosty_0.jpg",43,55);
        List<Pferd> pferdList = daoPferd.loadAll();
        assertFalse(pferdList.contains(pferd));
        daoPferd.save(pferd);
        pferdList = daoPferd.loadAll();
    ...
    public void deleteNonExisting() throws PersistenceException {
        ...
        Pferd pferd = new Pferd("0008","Luis","Haflinger",7,"0008_luis_0.jpg",40,50);
        List<Pferd> pferdList = daoPferd.loadAll();
        assertFalse(pferdList.contains(pferd));
        daoPferd.delete(pferd);
        pferdList = daoPferd.loadAll();
    ...
    public void isFreeChip_NrTest() throws PersistenceException {
        ...
        assertTrue(daoPferd.isFreeChip_Nr("0010"));
        assertFalse(daoPferd.isFreeChip_Nr("0000"));
    }
    ...
    public void getFreeChip_NrTest() throws PersistenceException {
        ...
        List<String> chip_nrList = new ArrayList<>();
        for(Pferd pferd : daoPferd.loadAll()) {
            chip_nrList.add(pferd.getChip_nr());
        }
        String chip_nrLoaded = daoPferd.getFreeChip_Nr();
