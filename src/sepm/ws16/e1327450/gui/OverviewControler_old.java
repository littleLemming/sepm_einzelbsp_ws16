...
public class OverviewControler_old {
    ...
    private void initialize() {
        pferdChipNrColumn.setCellValueFactory(cellData -> new ReadOnlyObjectWrapper(cellData.getValue().getChip_nr()));
        ...
        rennergebnisChipNrColumn.setCellValueFactory(cellData -> (cellData.getValue() == null) ? new ReadOnlyStringWrapper("unknown") : new ReadOnlyObjectWrapper(cellData.getValue().getPferd().getChip_nr()));
        ...
        rennergebnisGeschwColumn.setCellValueFactory(cellData -> new ReadOnlyObjectWrapper(cellData.getValue().getDgeschw()));
